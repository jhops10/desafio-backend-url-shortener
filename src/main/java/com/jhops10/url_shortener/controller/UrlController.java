...
import com.jhops10.url_shortener.controller.dto.ShortenUrlResponse;
import com.jhops10.url_shortener.entity.UrlEntity;
import com.jhops10.url_shortener.repository.UrlRepository;
...
public class UrlController {
    ...
    public ResponseEntity<ShortenUrlResponse> shortenUrl(@RequestBody ShortenUrlRequest shortenUrlRequest,
        ...
        urlRepository.save(new UrlEntity(id, shortenUrlRequest.url(), LocalDateTime.now().plusMinutes(1)));
